...
function (_Component) {
  ...
  _createClass(Textarea, [{
    ...
    key: "renderIcon",
    value: function renderIcon(icon, className) {
      return _react.default.createElement(_Icon.default, {
        className: (0, _classnames.default)('material-icons prefix', className)
      }, icon);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          other = _objectWithoutProperties(_this$props, ["className", "s", "m", "l", "xl", "noLayout", "iconClassName", "icon", "label", "id", "onChange"]);
      ...
      }, icon && this.renderIcon(icon, iconClassName), _react.default.createElement("textarea", _extends({}, other, {
        ref: function ref(input) {
          _this._textarea = input;
        },
        onChange: onChange,
        id: computedId,
        className: (0, _classnames.default)('materialize-textarea', className)
